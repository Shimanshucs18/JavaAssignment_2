...
public class Main {
    ...
    public static void cases(AssignmnetJava_Tuesday.Bank User, int c) {
    ...
    public static void Display() {
        ...
        switch (ch) {
            case 1: {
                Bank b = new SBI(12211, "Shimanshu", 2000);
                cases(b, c);
            }
            break;
            case 2: {
                Bank b = new BOI(12211, "Sharma", 2000);
                cases(b, c);
            }

            break;
            case 3: {
                Bank b = new ICICI(12211, "Shimanshu", 2000);
                cases(b, c);
            }
            break;
            default:
